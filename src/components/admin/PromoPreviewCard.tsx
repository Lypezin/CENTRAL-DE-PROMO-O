...
export default function PromoPreviewCard({
  ...
  return (
    <div className="rounded-xl border border-white/[0.04] bg-[#08080a] p-3 space-y-2">
      <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider font-mono flex items-center gap-1.5 px-1">
      ...
      <div
        className={`obsidian-card h-full flex flex-col relative group overflow-hidden ${
          isCopa
            ...
            : isNinja
              ? 'card-tema-ninja !bg-gradient-to-br !from-[#141414] !via-[#09090b] !to-[#020202] !border-zinc-800/80 shadow-[0_4px_30px_rgba(0,0,0,0.5)] shadow-black/80'
              : ''
        }`}
      >
        {isCopa && (
        ...
        {isCopa && (
          <svg
            ...
            stroke="currentColor"
            strokeWidth="1.0"
            className="absolute -right-4 -bottom-4 w-36 h-36 text-amber-500 opacity-[0.06] pointer-events-none select-none animate-float z-0"
          >
        ...
        <div className="p-5 flex flex-col flex-grow relative z-10">
          ...
          {cidade && (
            <div className="mb-2">
              <span className={`inline-flex items-center text-[9px] font-bold tracking-wider uppercase px-2.5 py-0.5 rounded font-mono backdrop-blur-sm ${
                isCopa
          ...
          <h3 className={`text-lg sm:text-xl font-bold mb-1.5 transition-all tracking-tight ${
            isCopa
          ...
          <p className={`text-xs mb-4 flex-grow line-clamp-2 leading-relaxed ${
            isCopa
          ...
          {(isCopa || isNinja) && config_turnos && config_turnos.length > 0 && (
            <div className={`mt-auto pt-2.5 border-t mb-3 ${isNinja ? 'border-zinc-800/40' : 'border-emerald-950/40'}`}>
          ...
          <div className="pt-3 border-t border-white/[0.04] flex items-center justify-between">
            ...
            <div className={`flex items-center gap-1 font-extrabold tracking-wider uppercase text-[10px] ${
              isCopa
                ? 'text-amber-400 bg-amber-500/10 px-3 py-1.5 rounded-lg border border-amber-500/20 shadow-inner'
                : isNinja
                  ? 'text-rose-400 bg-rose-950/10 px-3 py-1.5 rounded-lg border border-rose-950/30 shadow-[0_0_8px_rgba(225,29,72,0.05)]'
                  : 'text-sky-400'
            }`}>
