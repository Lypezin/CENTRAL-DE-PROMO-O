...
function RankingLeaderboardComponent({
  ...
  return (
    <div className="flex flex-col animate-fade-in space-y-6 w-full max-w-full overflow-hidden">
      ...
      {!searchQuery && (podiumData.first || podiumData.second || podiumData.third) && (
        <div className="sm:hidden flex items-end justify-center gap-2 mb-6 pt-12 pb-2 select-none w-full max-w-full overflow-hidden px-1 h-52 relative bg-zinc-950/20 border border-white/[0.02] rounded-2xl">
          {/* Gold Glow Mask */}
          ...
          {podiumData.second && (() => {
            ...
            return (
              <div className="w-[32%] flex flex-col justify-end items-center h-full">
                <div className="bg-[#08080a] border border-slate-500/15 rounded-t-xl h-32 w-full flex flex-col justify-between p-2 relative shadow-lg">
                  {/* Rank circle */}
          ...
          {podiumData.first && (() => {
            ...
            return (
              <div className="w-[36%] flex flex-col justify-end items-center h-full scale-[1.03] z-10">
                <div className="bg-[#09090c] border border-yellow-600/35 rounded-t-xl h-38 w-full flex flex-col justify-between p-2 relative shadow-xl glow-yellow-neon">
                  {/* Floating Crown */}
          ...
          {podiumData.third && (() => {
            ...
            return (
              <div className="w-[32%] flex flex-col justify-end items-center h-full">
                <div className="bg-[#08080a] border border-amber-800/20 rounded-t-xl h-28 w-full flex flex-col justify-between p-2 relative shadow-lg">
                  {/* Rank circle */}
